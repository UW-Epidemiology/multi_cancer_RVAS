...
workflow SAIGE_sparse_null_models_individual_cancers {
  input {
    File sparseGRM_file
    ...
    File WES_fam_file
    File pheno_file
    Array[String] phenotypes = ["colorectal", "NHL", "leukemias", "oral", "neck", "anus", "bladder", "brain", "bone", "esophagus", "eye", "HL", "kidney", "liver", "lung", "non_melanoma", "melanoma", "myeloma", "pancreas", "stomach", "thyroid"]
    Array[String] instance_types = ["mem2_ssd1_v2_x16", "mem2_ssd1_v2_x16", "mem2_ssd1_v2_x16", "mem2_ssd1_v2_x16", "mem2_ssd1_v2_x16", "mem2_ssd1_v2_x16", "mem2_ssd1_v2_x16", "mem2_ssd1_v2_x16", "mem2_ssd1_v2_x16", "mem2_ssd1_v2_x16", "mem2_ssd1_v2_x16", "mem2_ssd1_v2_x16", "mem2_ssd1_v2_x16", "mem2_ssd1_v2_x16", "mem2_ssd1_v2_x16", "mem2_ssd1_v2_x16", "mem2_ssd1_v2_x16", "mem2_ssd1_v2_x16", "mem2_ssd1_v2_x16", "mem2_ssd1_v2_x16", "mem2_ssd1_v2_x16"]  
  }
...
task SAIGE_1_sparse_GRM {
  ...
  command <<<
    ...
    /usr/bin/time -o SAIGE_step1.runinfo.txt -v step1_fitNULLGLMM.R \
        ...
        --phenoCol=~{pheno} \                                     
        --covarColList=Age_at_recruitment,Female,UKB_PC1,UKB_PC2,UKB_PC3,UKB_PC4,UKB_PC5,UKB_PC6,UKB_PC7,UKB_PC8,UKB_PC9,UKB_PC10,UKB_PC11,UKB_PC12,UKB_PC13,UKB_PC14,UKB_PC15,UKB_PC16,UKB_PC17,UKB_PC18,UKB_PC19,UKB_PC20 \                                

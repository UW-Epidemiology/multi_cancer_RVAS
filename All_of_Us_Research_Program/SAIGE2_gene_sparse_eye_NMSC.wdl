...
workflow SAIGE_GENE_sparse_individual_cancers {
  input {
    ...
    Array[String] phenotypes = ["eye",  "non_melanoma"]
    Array[Int] chromosome_indices = [0, 1, 2, 3, 5, 6, 8, 10, 11, 12, 14, 15, 16, 18, 19, 21] 
    Array[String] instance_mem = ["32GB", "32GB", "32GB", "32GB", "32GB", "32GB", "32GB", "16GB", "32GB", "32GB", "32GB", "32GB", "16GB", "16GB", "16GB", "32GB", "32GB", "16GB", "32GB", "16GB", "16GB", "16GB"]   
    Array[Int] instance_cpu = [8, 8, 8, 8, 8, 8, 8, 4, 8, 8, 8, 8, 4, 4, 4, 8, 8, 4, 8, 4, 4, 4]   

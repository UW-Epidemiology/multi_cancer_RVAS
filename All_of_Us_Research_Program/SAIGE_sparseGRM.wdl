...
task SAIGE_step0 {
  ...
  output {
    File matrix_file = "srWGS_EHR_relatednessCutoff_0.25_5000_randomMarkersUsed.sparseGRM.mtx"
    File matrix_sample_file = "srWGS_EHR_relatednessCutoff_0.25_5000_randomMarkersUsed.sparseGRM.mtx.sampleIDs.txt"
  }
}

...
workflow SAIGE_GENE_sparse_individual_cancers {
  input {
    ...
    Array[String] phenotypes = ["anus", "bladder", "bone", "breast", "brain", "cervix", "colorectal", "endometrium", "esophagus", "HL", "kidney", "leukemias", "liver", "lung", "melanoma", "myeloma", "NHL", "neck", "oral", "ovary", "pancreas", "prostate", "stomach", "testis", "thyroid", "eye", "non_melanoma"]
    Int chr_index = 19
    Array[String] instance_mem = ["16GB"]
    Array[Int] instance_cpu = [4]
    Array[String] instance_disk1 = ["local-disk 200 SSD"]
    Array[String] instance_disk2 = ["local-disk 125 SSD"]
  }
  ...
  scatter (pheno_index in range(length(phenotypes))) {
    call SAIGE_2 {
      input:
        ...
        chr = chr_index + 1,
        disk = instance_disk2[0]
    }
  }

  output {
    Array[File] output_txt = SAIGE_2.results_txt
    Array[File] output_txt_markers = SAIGE_2.results_txt_markers
    Array[File] output_txt_single = SAIGE_2.results_single_txt
  }
}

...
cd /projects/lindstroem/UKBB_AoU_WGS_annotations/AoU/WGS_v7.1_coordinates/

# Set input file path
input="WGS_v7.1_variants_chrY_part1.tsv.gz"

# Set output file path
output="/projects/lindstroem/UKBB_AoU_WGS_annotations/AoU/block_annotations/WGS_v7.1_variants_chrY_part1_VEP_ANN.tsv"

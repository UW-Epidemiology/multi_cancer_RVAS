---
title: "QQ plots for SAIGE single variant results in AoU"
...
p_load(rlang, tidyverse, data.table, R.utils,
       ggplot2, gridExtra, purrr, cowplot)
```
...
for (j in c("ectoderm",
  ...
  single_results = NULL
  for (i in 1:22) {
      chr_results = fread(paste0("/lindstroem/austin_working/Dissertation/AoU/gene_based_results/cancer_groups/sparse_GRM/chr",i,"_",j,"_SAIGE_results.txt.singleAssoc.txt")) %>%

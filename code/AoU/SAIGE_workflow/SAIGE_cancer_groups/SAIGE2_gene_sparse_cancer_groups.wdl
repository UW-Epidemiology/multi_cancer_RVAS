...
workflow SAIGE_GENE_sparse_cancer_groups {
  input {
    ...
    Array[String] phenotypes = ["ectoderm"]
    ...
    Array[String] instance_disk1 = ["local-disk 800 SSD", "local-disk 750 SSD", "local-disk 500 SSD", "local-disk 400 SSD", "local-disk 500 SSD", "local-disk 500 SSD", "local-disk 500 SSD", "local-disk 300 SSD", "local-disk 400 SSD", "local-disk 400 SSD", "local-disk 500 SSD", "local-disk 500 SSD", "local-disk 200 SSD", "local-disk 300 SSD", "local-disk 350 SSD", "local-disk 400 SSD", "local-disk 500 SSD", "local-disk 100 SSD", "local-disk 500 SSD", "local-disk 250 SSD", "local-disk 100 SSD", "local-disk 200 SSD"]

...
workflow SAIGE_GENE_sparse_individual_cancers_SAMHD1 {
  input {
    ...
    Array[String] phenotypes = ["anus", "bladder", "bone", "breast", "brain", "cervix", "colorectal", "endometrium", "esophagus", "eye", "HL", "kidney", "leukemias", "liver", "lung", "melanoma", "myeloma", "NHL", "neck", "non_melanoma", "oral", "ovary", "pancreas", "prostate", "stomach", "testis", "thyroid"]
    Array[Int] chromosome_indices = [19]  
  }
